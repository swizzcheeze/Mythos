...
Iterative, persistent templates (character, location, faction, magic_system, creature, artifact, event, culture, conflict, ritual). Start → update fields → preview (finalize) → optionally commit as lore.
