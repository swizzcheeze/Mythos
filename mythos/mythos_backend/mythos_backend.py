...
def list_worlds():
    ...
    return {"worlds": worlds, "active_world": ACTIVE_WORLD_NAME, "counts": counts}
...
def create_world(req: WorldCreateRequest):
    ...
    return {"status": "success", "created": True, "active_world": ACTIVE_WORLD_NAME}
...
def select_world(req: WorldSelectRequest):
    ...
    LORE_DATABASE = load_lore_db()
    globals()['CREATION_SESSIONS'] = load_sessions()
    return {"status": "success", "active_world": ACTIVE_WORLD_NAME, "entries": len(LORE_DATABASE)}
